...
with open(inputFile, 'r') as inFile:
	with open("Crimes_Homicide.csv", 'w') as outFile:
		...
		crimewriter.writerow(next(crimereader))
		rowsToGet = [19, 20]
		for row in crimereader:
			#(row[5] == "BATTERY") Primary type of crime
			#(row[9] == "false") Domestic
			#(row[8] == "false") Arrests
