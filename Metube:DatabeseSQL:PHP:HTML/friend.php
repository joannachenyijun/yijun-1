...
$result = getFriend($_SESSION['username']);
if(mysql_num_rows($result) == 0){
    echo "Sorry! You don't have a friend!" ;
}
else{
    // $result = getFriend($_SESSION['username']);
    echo "<table border='0' cellpadding='10'>";
    echo "<tr><td style='font-size:22px; color:green;'>Friends</td></tr>";
...
<form method="post", action =<?php echo "friend_edit.php" ?> >
    <button name="edit" style='color:white; background-color:red; cursor:pointer;'>&nbsp;Edit Friends</button>
</form>
